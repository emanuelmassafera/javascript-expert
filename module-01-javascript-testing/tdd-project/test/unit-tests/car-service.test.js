...
const CarService = require('../../src/service/car-service.js')
...
describe('CarService Suite Tests', () => {
  ...
  it('should choose the first if from cartIds in cartCategory', () => {
  ...
  it('should calculate final amount in real', async () => {
